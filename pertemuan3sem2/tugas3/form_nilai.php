    ...
    <form action="data_nilai.php" method="POST" class="form-horizontal w-75 mt-5 mx-auto p-4 border shadow-sm">
        <div class="container px-3">
            <div class="form-group row mb-3">
                ...
                <div class="col-8">
                    <input name="namkap" id="nama_lengkap" type="text" class="form-control" placeholder="Siapa nama kamu?" required>
                </div>
            </div>
            <div class="form-group row mb-3">
                <label for="matkul" class="col-4 col-form-label">Mata Kuliah</label>
                <div class="col-8">
                    <select name = "mata_kuliah" id="matkul" required="required" class="form-select">
